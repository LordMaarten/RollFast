...
namespace pxg.Generator
{
    public static class Mesh
    {
        ...
        {
            var cubes = DataStructure.MarchingCube.GenerateCubes(res, chunkSize, chunkPos, generator);
        ...
        {
            var cubes = DataStructure.MarchingCube.GenerateCubes(res, chunk, generator);
            var m = new DataStructure.Mesh(cubes, tau);
