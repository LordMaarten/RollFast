...
namespace World.Generator
{
    public class SimplexNoiseGenerator
    {
        ...
        {
            return coherentNoise(new Vector3(x, y, z), octaves, multiplier, amplitude, lacunarity, persistence);
        }

        public float coherentNoise(Vector3 pos, int octaves = 1, int multiplier = 25, float amplitude = 0.5f, float lacunarity = 2, float persistence = 0.9f)
        {
            Vector3 v3 = pos / multiplier;
            float val = 0;
